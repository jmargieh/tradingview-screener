...
/**
 * CoinField contains all available fields for cryptocurrency screening on TradingView.
 * 
 * This file includes 3,026 fields discovered from TradingView API, including:
 * - 24-hour metrics (volume, price changes)
 * - Technical indicators (ADX, RSI, MACD, etc.)
 * - Moving averages (EMA, SMA, various periods)
 * - Candlestick patterns (Doji, Hammer, Engulfing, etc.)
 * - Bollinger Bands, Ichimoku, and other indicators
 ...
 * 
 * @see https://github.com/deepentropy/tvscreener/blob/main/tvscreener/field/coin.py
 */
export const CoinField = {
  ...
  N24H_VOL_CHANGE_5: new BaseField('N24H_VOL_CHANGE_5', {
    label: '24H Vol Change|5',
  ...
  N24H_VOL_5: new BaseField('N24H_VOL_5', {
    label: '24H Vol|5',
    fieldName: '24h_vol|5',
    format: 'float',
    interval: true,
  ...
  HIGH_1M_2: new BaseField('HIGH_1M_2', {
    label: 'High|1M',
    fieldName: 'high|1M',
    format: 'float',
    interval: true,
  ...
  LOW_1M_2: new BaseField('LOW_1M_2', {
    label: 'Low|1M',
    fieldName: 'low|1M',
    format: 'float',
    interval: true,
  ...
  MARKET_CAP_DILUTED_CALC: new BaseField('MARKET_CAP_DILUTED_CALC', {
    label: 'Market Cap Diluted Calc',
  ...
  TOTAL_SHARES_DILUTED: new BaseField('TOTAL_SHARES_DILUTED', {
  ...
  TOTAL_VALUE_TRADED: new BaseField('TOTAL_VALUE_TRADED', {
